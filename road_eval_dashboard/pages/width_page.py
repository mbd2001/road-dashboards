...
from road_eval_dashboard.components.components_ids import (
    ...
    MD_FILTERS,
    NETS, WIDTH_ROLES_DROPDOWN, WIDTH_3D_SOURCE_DROPDOWN,
)
...
from road_eval_dashboard.components.queries_manager import (
    run_query_with_nets_names_processing, Roles, ZSources,
)
...
@callback(
    Output({"out": "graph_by_Z", "width_type": WIDTH_TYPE, "tab": ALL}, "figure"),
    Input(MD_FILTERS, "data"),
    Input(WIDTH_ROLES_DROPDOWN, "value"),
    Input(NETS, "data"),
    State(EFFECTIVE_SAMPLES_PER_BATCH, "data"),
    State({"out": "graph_by_Z", "width_type": WIDTH_TYPE, "tab": ALL}, "id"),
    background=True,
)
...
def get_labels_and_preds(source):
    base_label_name = "gt_valid_count"
    base_pred_name = f"{source}_success_rate"
    labels = []
    preds = []
