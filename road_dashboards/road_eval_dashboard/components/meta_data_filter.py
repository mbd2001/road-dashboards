    ...
    card_wrapper(
        [
            ...
            dbc.Stack(
                [
                    dbc.Button(
                        "Update Filters", id="update_filters_btn", color="success", style={"margin": "10px 10px 10px 0"}
                    ),
                    dbc.Button(
                        "Open in MExsense",
                        id="mexsense_btn_filters",
                        color="success",
...
@callback(
    Output("mexsense_btn_filters", "disabled"),
    Output("mexsense_btn_filters", "href"),
