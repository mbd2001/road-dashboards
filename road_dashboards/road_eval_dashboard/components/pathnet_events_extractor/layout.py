...
def create_ref_net_options_dropdown_row():
    return html.Div(id=PATHNET_EVENTS_REF_DIV, children=[dbc.Row(
        [
            dbc.Col(
                loading_wrapper(dcc.Dropdown(id=PATHNET_EVENTS_REF_NET_ID_DROPDOWN, placeholder="Select ref Net-ID"))
            ),
            dbc.Col(
                loading_wrapper(
...
def create_filtering_dropdowns_row():
    return dbc.Row(
        [
            ...
            dbc.Col(
                html.Div(id=PATHNET_EVENTS_ROLE_DROPDOWN_DIV, children=[dcc.Dropdown(
            ...
            dbc.Col(
                html.Div(id=PATHNET_EVENTS_DIST_DROPDOWN_DIV, children=[dcc.Dropdown(
