...
class PathNet(Base):
    dp_points: Column = Column("dp_points", list[float], drawable=True)
    dv_dp_points: Column = Column("dv_dp_points", list[float], drawable=True)
    dp_points_oncoming: Column = Column("dp_points_oncoming", str, drawable=True)
