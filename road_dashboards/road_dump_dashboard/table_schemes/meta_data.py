...
class MetaData(Base):
    ...
    dist_from_lanesplit_hostleft: Column = Column("dist_from_lanesplit_hostleft", float)
    dist_from_lanesplit_hostright: Column = Column("dist_from_lanesplit_hostright", float)
    ...
    dist_to_lanesplit_hostleft: Column = Column("dist_to_lanesplit_hostleft", float)
    dist_to_lanesplit_hostright: Column = Column("dist_to_lanesplit_hostright", float)
    ...
    max_split_branch_heading_deg_rpw: Column = Column("max_split_branch_heading_deg_rpw", float)
    ...
    splited_branches_dist_rpw: Column = Column("splited_branches_dist_rpw", float)
    fw_splited_branches_dist_rpw: Column = Column("fw_splited_branches_dist_rpw", float)
    host_fw_dist_to_splitted_branch_rpw: Column = Column("host_fw_dist_to_splitted_branch_rpw", float)
    ...
    avail_exist_rpw: Column = Column("avail_exist_rpw", bool)
    perf_proj: Column = Column("perf_proj", int)
    num_path_merges_rpw: Column = Column("num_path_merges_rpw", float)
    num_path_splits_rpw: Column = Column("num_path_splits_rpw", float)
    split_in_bins_rpw: Column = Column("split_in_bins_rpw", bool)
    crossing_host_dist_rpw: Column = Column("crossing_host_dist_rpw", float)
    crossing_rel_dist: Column = Column("crossing_rel_dist", float)
    crossing_oncoming_dist_rpw: Column = Column("crossing_oncoming_dist_rpw", float)
    ...
    all_hosts_turn_in_junction_rpw: Column = Column("all_hosts_turn_in_junction_rpw", bool)
    no_host_in_frame_rpw: Column = Column("no_host_in_frame_rpw", bool)
    host_re_boundary_left: Column = Column("host_re_boundary_left", float)
    ...
    in_junction_turning_rpw: Column = Column("in_junction_turning_rpw", bool)
    ...
    num_arrows_in_frame_rpw: Column = Column("num_arrows_in_frame_rpw", float)
    turn_arrows_in_frame_rpw: Column = Column("turn_arrows_in_frame_rpw", bool)
    closest_arrow_z_rpw: Column = Column("closest_arrow_z_rpw", float)
