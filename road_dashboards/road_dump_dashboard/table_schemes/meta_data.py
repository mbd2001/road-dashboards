...
class MetaData(Base):
    ...
    allocated_size_lm2_x: Column = Column("allocated_size_lm2_x", float)
    allocated_size_lm2_y: Column = Column("allocated_size_lm2_y", float)
    allocated_size_x_lm1: Column = Column("allocated_size_x_lm1", float)
    allocated_size_x_lm2: Column = Column("allocated_size_x_lm2", float)
    allocated_size_y_lm1: Column = Column("allocated_size_y_lm1", float)
    allocated_size_y_lm2: Column = Column("allocated_size_y_lm2", float)
    aug_index: Column = Column("aug_index", float)
    aug_right_shift: Column = Column("aug_right_shift", float)
    aug_rotation_angle: Column = Column("aug_rotation_angle", float)
    aug_up_shift: Column = Column("aug_up_shift", float)
    augmented_warp: Column = Column("augmented_warp", float)
    ava_tag: Column = Column("ava_tag", float)
    availability_available: Column = Column("availability_available", bool)
    batch_rpw: Column = Column("batch_rpw", float)
    ...
    camk_00: Column = Column("camk_00", float)
    camk_01: Column = Column("camk_01", float)
    camk_02: Column = Column("camk_02", float)
    camk_03: Column = Column("camk_03", float)
    camk_04: Column = Column("camk_04", float)
    ...
    distort_params_00: Column = Column("distort_params_00", float)
    distort_params_01: Column = Column("distort_params_01", float)
    distort_params_02: Column = Column("distort_params_02", float)
    distort_params_03: Column = Column("distort_params_03", float)
    distort_params_04: Column = Column("distort_params_04", float)
    distort_params_05: Column = Column("distort_params_05", float)
    distort_params_06: Column = Column("distort_params_06", float)
    distort_params_07: Column = Column("distort_params_07", float)
    distort_params_08: Column = Column("distort_params_08", float)
    ...
    dv_aug_pitch: Column = Column("dv_aug_pitch", float)
    dv_aug_roll: Column = Column("dv_aug_roll", bool)
    dv_aug_x_offset: Column = Column("dv_aug_x_offset", float)
    dv_aug_yaw: Column = Column("dv_aug_yaw", float)
    dv_aug_z_offset: Column = Column("dv_aug_z_offset", float)
    ...
    grabindex_main: Column = Column("grabindex_main", float)
