...
group_by_graphs = [
    GroupByGraphProperties(name="Role Distribution", group_by_column="dp_role"),
    GroupByGraphProperties(
    ...
    GroupByGraphProperties(name="Oncoming Distribution", group_by_column="dp_points_oncoming"),
